...
var Referrals = function () {
    var countRef = 1;
    return (<div className={styles.referralsModule}>
			...
			<div className={styles.blockReferrals}>
				<div className={styles.leftAndRight}>
					<div className={styles.left}>
						...
						<div className={styles.progressBar}>
							<div className={styles.valueProgressBar} style={{ width: "".concat(countRef * 25, "%") }}></div>
					...
					<div className={styles.right}>
						...
						<div className={styles.progressBar}>
							<div className={styles.valueProgressBar} style={{ width: "".concat(countRef * 25, "%") }}></div>
							<p className={styles.countRef}>{"".concat(countRef * 25, "%")}</p>
						</div>
					</div>
				</div>
				<div className={styles.circleReferrals}>
					<div className={styles.left}>
						<p className={styles.p}>Ближний круг рефералов</p>
						<div className={styles.progressBar}>
							<div className={styles.valueProgressBar} style={{ width: "".concat((countRef + 1) * 25, "%") }}></div>
							<p className={styles.countRef}>{countRef + 1} из 4</p>
						</div>
						<div className={styles.progressBarUser}>
							<div className={styles.valueProgressBarUser} style={{ width: "0%" }}></div>
					...
					<div className={styles.center}>
						...
						<div className={styles.progressBar}>
							<div className={styles.valueProgressBar} style={{ width: "".concat((countRef + 4) * (100 / 16), "%") }}></div>
							<p className={styles.countRef}>{countRef + 4} из 16</p>
						</div>

						<div className={styles.progressBar}>
							<div className={styles.valueProgressBar} style={{ width: "".concat((countRef + 15) * (100 / 16), "%") }}></div>
							<p className={styles.countRef}>{countRef + 15} из 16</p>
						</div>

						<div className={styles.progressBar}>
							<div className={styles.valueProgressBar} style={{ width: "".concat((countRef + 11) * (100 / 16), "%") }}></div>
					...
					<div className={styles.right}>
						...
						<div className={styles.progressBar}>
							<div className={styles.valueProgressBar} style={{ width: "".concat((countRef + 6) * (100 / 64), "%") }}></div>
							<p className={styles.countRef}>{countRef + 6} из 64</p>
						</div>

						<div className={styles.progressBar}>
							<div className={styles.valueProgressBar} style={{ width: "".concat((countRef + 51) * (100 / 64), "%") }}></div>
							<p className={styles.countRef}>{countRef + 51} из 64</p>
						</div>

						<div className={styles.progressBar}>
							<div className={styles.valueProgressBar} style={{ width: "".concat((countRef + 27) * (100 / 64), "%") }}></div>
